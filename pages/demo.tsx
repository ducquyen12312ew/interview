              ...
              >
                <ul className="mb-auto list-none">
                  ...
                  <li className="mt-4 list-none flex items-center rounded-[9px] text-gray-900 py-[2px]">
                    ...
                    <p className="ml-[3px] mr-[6px]">Trang chủ</p>
                  </li>
                  <li className="mt-1 list-none flex items-center rounded-[9px] text-gray-900 py-[4px]">
                    ...
                    <p className="ml-[3px] mr-[6px]">Kho Phỏng Vấn</p>
                  ...
                  <li className="mt-1 list-none flex items-center rounded-[9px] text-gray-900 py-[4px]">
                    ...
                    <p className="ml-[3px] mr-[6px]">Câu hỏi của tôi</p>
                  </li>
                  <li className="mt-1 list-none flex items-center rounded-[9px] text-gray-900 py-[4px]">
                    <svg
                      className="h-4 w-4 text-gray-700"
                    ...
                    <p className="ml-[3px] mr-[6px]">Cộng đồng</p>
                  </li>
                  <li className="mt-1 list-none flex items-center rounded-[9px] text-gray-900 py-[4px]">
                    <svg
                      className="h-4 w-4 text-gray-700"
                    ...
                    <p className="ml-[3px] mr-[6px]">Tài liệu</p>
                  </li>
                  <li className="mt-1 list-none flex items-center rounded-[9px] text-gray-900 py-[4px]">
                    <svg
                      className="h-4 w-4 text-gray-700"
                    ...
                    <p className="ml-[3px] mr-[6px]">Cài đặt</p>
                  </li>
                </ul>
